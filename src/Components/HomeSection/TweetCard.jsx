        ...
        <div className='w-full'>
          <div className='flex justify-between items-center'>
            <div className='flex cursor-pointer items-center space-x-2'>
              <span className='font-semibold'>Alex Giounan</span>
              <span className='text-gray-600'>@alexgiounan . 2m</span>
          ...
          <div className='mt-2'>
            ...
            <div className='py-5 flex flex-wrap justify-between items-center'>
              ...
              <div className={`${true ? "text-pink-600" : "text-gray-600"} space-x-3 flex items-center`}>
                {true ? <FavoriteIcon className='cursor-pointer' onClick={handleLikeTweet} /> : <FavoriteOutlined className='cursor-pointer' onClick={handleLikeTweet} />}
                <p>54</p>
              </div>
              <div className='space-x-3 flex items-center text-gray-600 '>
